...
public class InfoViewPanel extends JPanel{
	...
	public InfoViewPanel() {
		...
		String infoText = "<html>"
                ...
                + "<p>Slower alien: This type of alien also tries to prevent the player from finding the key. However, it is a bit different from the other aliens. This alien is not dangerous. It can only slow the player down. If the player is close to the slower alien,</p>"
                + "<p>the player's speed decreases. To avoid this, the player can use a speed boost power-up.</p>\n"
                + "<h2>Power-ups</h2>\n"
                + "<p>During the game, the player can collect power-ups to help her/him along the way. There are 3 types of power-ups:</p>\n"
                + "<p>- Speed boost: This power-up increases the player's speed for a short period of time.</p>\n"
